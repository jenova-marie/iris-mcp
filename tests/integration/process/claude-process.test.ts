...
describe("ClaudeProcess Integration", () => {
  ...
  describe("RxJS observability", () => {
    it(
      "should emit status$ observable during process lifecycle",
      async () => {
    ...
    it.skip(
      "should emit errors$ when process fails",
      async () => {
    ...
    it(
      "should emit both observables and EventEmitter events (bridge)",
      async () => {
        claudeProcess = new ClaudeProcess(
          "team-alpha",
          testIrisConfig,
  ...
  describe("process spawning", () => {
    it(
      "should spawn claude process successfully",
      async () => {
        claudeProcess = new ClaudeProcess(
          "team-alpha",
          testIrisConfig,
    ...
    it(
      "should transition to IDLE/PROCESSING after spawn completes",
      async () => {
        claudeProcess = new ClaudeProcess(
          "team-alpha",
          testIrisConfig,
